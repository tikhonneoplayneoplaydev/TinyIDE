...
// ─── Themes (dynamic — rebuilt when accent/theme changes) ──────────────────

type Accent = { c1: string; c2: string; c3: string };

export function buildCometTheme(accent: Accent, dark: boolean): monaco.editor.IStandaloneThemeData {
  const a = accent.c1;
  const sel = a + '4d';
  const selSoft = a + '2e';
  return dark
    ? {
        ...
        colors: {
          ...
          'editor.lineHighlightBackground': a + '0d',
          'editor.lineHighlightBorder': '#00000000',
          'editor.selectionBackground': sel,
          'editor.inactiveSelectionBackground': selSoft + '77',
          'editor.selectionHighlightBackground': selSoft,
          'editor.wordHighlightBackground': selSoft + '22',
          ...
          'editorBracketMatch.background': selSoft,
          ...
          'editorSuggestWidget.selectedBackground': selSoft,
    ...
    : {
        ...
        colors: {
          ...
          'editorCursor.foreground': a,
          'editor.lineHighlightBackground': a + '14',
          'editor.selectionBackground': a + '33',
          'editor.inactiveSelectionBackground': a + '1f',
          ...
          'editorSuggestWidget.selectedBackground': a + '22',
          'editorSuggestWidget.highlightForeground': a,
          ...
          'input.border': '#d7ddee',
          'focusBorder': a,
          'list.activeSelectionBackground': a + '22',
          'list.hoverBackground': '#eef2fa',
          'quickInput.background': '#ffffff',
          'button.background': a,
          'button.foreground': '#ffffff',
          'editor.findMatchBackground': a + '44',
          'editor.findMatchHighlightBackground': a + '2e',
        },
      };
}

export function applyCometTheme(accent: Accent, dark: boolean) {
  monaco.editor.defineTheme('comet-dark', buildCometTheme(accent, dark));
  monaco.editor.defineTheme('comet-light', buildCometTheme(accent, dark));
  monaco.editor.setTheme(dark ? 'comet-dark' : 'comet-light');
}
